...
function () {
  ...
  function Attributes(data) {
    ...
    this.data = data; // 리턴 타입은 정해져 있지 않기 때문에 수정해야 한다.
    // 유티언 타입 말고 다른 방법
...
exports.Attributes = Attributes; // 1. in typescript string can be type
...
function () {
  function Model(attributes, events, sync) {
    ...
    this.events = events;
    this.sync = sync; // getter 짧게 쓰는 문법, constructor argument로 event와, atrributes를 정의해서 사용하능한 문법
...
exports.User = User; // User 클래스에서 Model 클래스로 속성을 추출하기 전의 코드
// export class User {
...
// 모델로 메소드 들을 가져 갔다.
// }
},{"./Eventing":"src/models/Eventing.ts","./ApiSync":"src/models/ApiSync.ts","./Attributes":"src/models/Attributes.ts","./Collection":"src/models/Collection.ts","./Model":"src/models/Model.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
},{}]},{},["../../../.nvm/versions/node/v14.15.5/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
